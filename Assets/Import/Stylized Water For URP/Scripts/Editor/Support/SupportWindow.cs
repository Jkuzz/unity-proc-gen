...
namespace StylizedWater
{
    ...
    public class SupportWindow : EditorWindow
    {
        ...
        private void CheckUnityVersion()
        {
            ...
            else if (unityVersion.StartsWith("2020.2") || unityVersion.StartsWith("2020.3") || unityVersion.StartsWith("2020.4") || unityVersion.StartsWith("2021.1") || unityVersion.StartsWith("2021."))
            {
                unityVersionIcon.style.backgroundImage = Background.FromTexture2D(neutral);
                CheckSRPVersion();
            }
